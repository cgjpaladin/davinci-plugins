...
def _single(asr_lines, context_lines, offset=0, timeline_name="", episode="", system_candidates="", cpl=0, temperature=0, rules_subset=None):
    ...
    _examples = {
        ...
        9: '  {"index": 10, "original": "我时常幻想如果｜我是一个亿万富翁", "correction": "我时常幻想｜如果我是一个亿万富翁", "reason": "断句"},\n'
           ...
           '  {"index": 3, "original": "她慢慢地拿起桌上的文｜件签下了名字", "correction": "她慢慢地拿起桌上的｜文件签下了名字", "reason": "断句"}\n',
    }
    ...
    messages = [
        {"role": "system", "content": (
            ...
            "- 提取字幕中所有人名（如「叶校长」「张三」）\n"
            "- 提取剧本中所有人名\n"
            "- 至少 1 个名字同时出现在剧本和字幕 → same_show=true\n"
            "- 剧本不含人物故事（如纯技术文档、表格、笔记、README、调试记录）→ same_show=false\n"
            "- 不确定 → same_show=false。宁可漏判，不可误判。\n"
